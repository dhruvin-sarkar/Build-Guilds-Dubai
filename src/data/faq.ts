...
export const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "A 1-day hardware meetup organized as part of Hack Club Blueprint's global Build Guilds week (April 13–19). Hack Club funds local organizers to run events in their cities. Free, open to any teen who's curious about hardware.",
  },
  {
    question: 'Is it free?',
