        ...
        <div className={styles.header}>
          <div className={styles.headerCopy}>
            ...
            <p className={styles.lead}>
              ...
              started as sketches, schematics, and BOM notes before they turned into hardware. Drag the carousel,
              rotate through the ring, and it keeps looping through the local snapshot of Blueprint work.
            </p>
          </div>
        </div>
